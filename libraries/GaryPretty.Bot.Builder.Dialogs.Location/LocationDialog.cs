...
using GaryPretty.Bot.Builder.Dialogs.Location.Azure;
using GaryPretty.Bot.Builder.Dialogs.Location.Bing;
using GaryPretty.Bot.Builder.Dialogs.Location.Dialogs;
